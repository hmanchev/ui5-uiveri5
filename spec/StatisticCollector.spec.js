...
describe("StatisticCollector", function() {
  ...
  describe("collectAction", function () {
    it("Should not crash and return undefined", function () {
      // Arrange
      var collectActionCall = reporter.collectAction.bind({
        /* currentSpec: undefined */
      });

      // Act
      var returnValue = collectActionCall();
